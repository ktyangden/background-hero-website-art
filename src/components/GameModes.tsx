    ...
    <section id="modes" className="py-20 bg-chainsaw-dark noise-bg">
      <div className="container mx-auto px-4">
        ...
        <Tabs defaultValue="story" className="w-full max-w-5xl mx-auto">
          ...
          {/* STORY MODE */}
          <TabsContent value="story" className="relative h-[500px] md:h-[600px] overflow-hidden rounded-md shadow-lg">
            <img 
            ...
            <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-4">
              <h3 className="font-bebas text-4xl md:text-5xl text-white mb-4">STORY MODE</h3>
              <p className="text-white/90 text-lg md:text-xl font-bold max-w-2xl mb-6">
                ...
                Experience key manga moments with stunning visuals and immersive gameplay.
              </p>
          ...
          {/* PVP MODE */}
          <TabsContent value="pvp" className="relative h-[500px] md:h-[600px] overflow-hidden rounded-md shadow-lg">
            <img 
            ...
            <div className="absolute inset-0 bg-black/50 z-10"></div>
            <div className="relative z-20 flex flex-col items-center justify-center h-full text-center px-4">
              <h3 className="font-bebas text-4xl md:text-5xl text-white mb-4">5V5 MODE</h3>
              <p className="text-white/90 text-lg md:text-xl font-bold max-w-2xl mb-6">
                Test your skills against other players in intense 5v5 battles. Choose Denji, Power, Aki and more—
                each with unique abilities and devil powers.
              </p>
              <Button className="bg-chainsaw-orange hover:bg-chainsaw-orange/90 text-white font-bebas px-10 py-6 rounded-md text-lg">
                JOIN BATTLE
              </Button>
